...
<body>
     ...
     <section>
          ...
          <div class="carbon-calc">
               ...
               <form action="">
                    <label for="elec-bill" class="el">Electricity Bill</label>
                    <input name="elec-bill" type="int" class="calc-input" id="ele">
                    ...
                    <a action="woop" href="./result.php" class="submit">Submit</a>
               </form>
          </div>
